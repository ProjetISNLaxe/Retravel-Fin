...
class Jeu :
    ...
    def new(self) :
        ...
        for plat in PLATFORM_LIST :
            Platform(self, *plat)
        pg.mixer.music.load(path.join(self.son_dir, 'Chagrin.wav'))
        self.run()
    ...
    def victory_screen(self):
        ...
        self.affiche_text("APPUYEZ sur LA CROIX pour RETOURNER au menu de Retravel", 22 , ORANGE, LARGEUR/2, HAUTEUR/2)
        pg.display.flip()
        self.wait_for_key()
        if self.running == False :
            pg.quit()
